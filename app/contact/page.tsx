                ...
                <div className="flex gap-3">
                  {socialIconLinks.map((s) => (
                    <a
                      ...
                      className="social-pop ui-bounce w-14 h-14 rounded-2xl border border-[var(--border)] bg-white flex items-center justify-center text-[var(--muted)] hover:text-[var(--brand-primary)] hover:border-[var(--brand-primary)] transition-colors"
                    >
